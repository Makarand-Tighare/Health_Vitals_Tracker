...
export default function WeeklySummary({ summary }: WeeklySummaryProps) {
  return (
    <div className="rounded-lg border border-gray-200 bg-white shadow-sm">
      ...
      {summary.faceTrend && (
        <div className="mt-4 sm:mt-6 rounded-lg border border-gray-200 bg-gray-50 p-4 sm:p-5">
      ...
      {summary.notesSummary && (
        <div className="mt-3 sm:mt-4 rounded-lg border border-gray-200 bg-gray-50 p-4 sm:p-5">
