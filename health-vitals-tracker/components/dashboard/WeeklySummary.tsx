  ...
  return (
    <div className="rounded-lg border border-gray-200 bg-white shadow-sm">
      <div className="border-b border-gray-200 bg-gray-50 px-6 py-4">
        ...
        <p className="mt-1 text-sm text-gray-600">{summary.weekStart} to {summary.weekEnd}</p>
      </div>
      <div className="p-6">
      ...
      {summary.faceTrend && (
        <div className="mt-6 rounded-lg border border-gray-200 bg-gray-50 p-5">
          <div className="text-sm font-semibold text-gray-900 mb-2">Face Trend</div>
          <div className="text-gray-700">{summary.faceTrend}</div>
        </div>
      )}

      {summary.notesSummary && (
        <div className="mt-4 rounded-lg border border-gray-200 bg-gray-50 p-5">
          <div className="text-sm font-semibold text-gray-900 mb-2">Notes Summary</div>
          <div className="text-gray-700 whitespace-pre-line text-sm leading-relaxed">{summary.notesSummary}</div>
        </div>
      )}
      </div>
    </div>
